...
var SCRIPTS_PATH, Uso, config, createPost, createScript, createTopic, downloadSource, fs, https, loadScripts, m, marked, modifyScript, path, qs, router, saveScripts, scripts, unwatchScript, url_parser, uso;
...
createPost = function(file, info) {
  var body, commit, commits, markdownmessage, script, _i, _len, _ref;
  script = scripts[file];
  if (!script.topic) {
    return;
  }
